...
Подписывая этот договор вы соглашаетесь со всеми его условиями.

Кредитный договор между BOB BANK (Кредитор) и ${userName} (Заемщик) 
о предоставлении займа в размере ${amount} евро на срок 1 год 
под ${rate}% годовых.

УСЛОВИЯ КРЕДИТА:
• Сумма займа: ${amount} евро
...
1. Заемщик обязуется возвращать заем равными платежами.
2. Договор осуществляется между банком и заемщиком.
3. Разрыву с непогашенным долгом договор не подлежит.
4. Заемщик обязуется вернуть полную сумму в течение 12 месяцев.
5. Проценты начисляются с даты выдачи кредита.

СУДЕБНЫЕ СПОРЫ:
В случае минимальной неуплаты, заемщик не имеет претензий к банку 
за любые судебные процессы, направленные против него. 
Любые споры решаются в судебном порядке.

ЗАКЛЮЧИТЕЛЬНЫЕ ПОЛОЖЕНИЯ:
Обе стороны подтверждают свое согласие с условиями договора 
и уставом банка BOB BANK. Договор вступает в силу с момента 
подписания обеими сторонами.

Подпись представителя банка (Кредитора): TkLV
Подпись заемщика: ________________

Дата: ${date}
Печать банка: [BOB BANK]
    `;
